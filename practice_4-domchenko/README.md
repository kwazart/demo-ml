...
* Локальный:
  * `http://localhost:8001/` - расположено приветствие, можно проверить, что сервер запущен
  * `http://localhost:8001/docs` - расположена документация
  * `http://localhost:8001/predict/` - метод с моделями, примеры запросов ниже
* В облаке:
  * `http://158.160.132.70:8001/` - расположено приветствие, можно проверить, что сервер запущен
  * `http://158.160.132.70:8001/docs` - расположена документация
  * `http://158.160.132.70:8001/predict/` - метод с моделями, примеры запросов ниже
...
`curl -X 'POST'
    'http://158.160.132.70:8001/predict/'
    -H 'Content-Type: application/json'
    -d '{
    "url": "https://parkingcars.ru/wp-content/uploads/2021/02/stoyanka-1024x683.jpg",
    "targets": "car"
